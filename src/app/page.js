  ...
  return (
    <div className="grid min-h-[88vh] items-start gap-5 lg:items-center lg:gap-8 lg:grid-cols-[1.05fr,0.95fr]">
      <section className="rounded-[22px] p-4 sm:rounded-[28px] sm:p-5 sm:rounded-[36px] sm:p-8 shadow-[0_20px_70px_rgba(71,119,143,0.08)]" style={{ background: `linear-gradient(135deg, ${BRAND.white} 0%, ${BRAND.blueLight} 60%, ${BRAND.yellowLight} 100%)`, border: `1px solid ${BRAND.border}` }}>
        ...
        <h1 className="mt-5 text-4xl font-black tracking-tight sm:text-6xl" style={{ color: BRAND.navy }}>
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-3">
          ...
          <FeaturePill text="Manual / auto filtering" />
        </div>
      </section>
      ...
      <section className="rounded-[36px] bg-white p-8 shadow-[0_20px_70px_rgba(71,119,143,0.08)] ring-1" style={{ borderColor: BRAND.border }}>
        <div className="mb-5 grid grid-cols-2 gap-2 sm:flex">
          ...
          <button onClick={() => setAuthMode("signup")} className="rounded-2xl px-4 py-2 text-sm font-bold" style={authMode === "signup" ? { backgroundColor: BRAND.navy, color: BRAND.white } : { backgroundColor: BRAND.blueLight, color: BRAND.navy }}>
            Create profile
          </button>
        </div>
        ...
        <p className="mt-2 text-sm leading-6" style={{ color: BRAND.slate }}>
          This is a scaffold for proper accounts later. Right now it saves locally, but the structure is ready for real sign-in next.
        </p>
        ...
        <div className="mt-6">
          <p className="mb-3 text-xs font-black uppercase tracking-[0.22em]" style={{ color: BRAND.slate }}>Future account sign-in scaffold</p>
          <div className="grid gap-3 sm:grid-cols-2">
            <button onClick={() => onProviderClick("google")} className="rounded-2xl px-4 py-3 text-sm font-bold ring-1" style={{ backgroundColor: BRAND.white, color: BRAND.navy, borderColor: BRAND.border }}>
              Continue with Google
            </button>
            <button onClick={() => onProviderClick("apple")} className="rounded-2xl px-4 py-3 text-sm font-bold ring-1" style={{ backgroundColor: BRAND.white, color: BRAND.navy, borderColor: BRAND.border }}>
              Continue with Apple
            </button>
          </div>
        </div>
  ...
  return (
    <div className="flex items-center gap-2 rounded-full px-2 py-2" style={{ backgroundColor: BRAND.blueLight, border: `1px solid ${BRAND.border}` }}>
      {[
        ...
        const selected = transmission === item.id;
        return (
          <button key={item.id} onClick={() => updateTransmission(item.id)} className={`rounded-full font-bold ${compact ? "px-3 py-1 text-xs" : "px-4 py-2 text-sm"}`} style={selected ? { backgroundColor: BRAND.navy, color: BRAND.white } : { backgroundColor: BRAND.white, color: BRAND.navy }}>
            {item.label}
          </button>
        );
      })}
...
function ActionCard({ title, copy, button, onClick, tone }) {
  ...
  return (
    <div className="rounded-[32px] p-5 shadow-[0_20px_60px_rgba(71,119,143,0.06)] ring-1" style={{ ...styles[tone], borderColor: BRAND.border }}>
      ...
      <button onClick={onClick} className="mt-5 rounded-2xl px-4 py-3 text-sm font-bold" style={{ backgroundColor: BRAND.navy, color: BRAND.white }}>
        {button}
      </button>
    </div>
  );
            ...
            <section key={section.id} className="overflow-hidden rounded-[32px] bg-white shadow-[0_20px_60px_rgba(71,119,143,0.05)] ring-1" style={{ borderColor: BRAND.border }}>
              <button onClick={() => toggleSection(section.id)} className="flex w-full flex-col items-start justify-between gap-4 px-4 py-4 text-left sm:flex-row sm:items-center sm:px-6 sm:py-5">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="rounded-full px-3 py-2 text-sm font-black" style={{ backgroundColor: BRAND.blueLight, color: BRAND.navy }}>{open ? "Hide" : "Show"}</span>
                </div>
              </button>
                ...
                <div className="p-4 sm:p-6" style={{ borderTop: `1px solid ${BRAND.border}` }}>
                  <div className="space-y-4">
                    {section.modules.map((module) => (
                      <div key={module.title} className="rounded-[28px] p-4 ring-1 sm:p-5" style={{ backgroundColor: BRAND.blueLight, borderColor: BRAND.border }}>
        ...
        <section className="space-y-6">
          <div className="rounded-[32px] p-6 shadow-[0_20px_60px_rgba(71,119,143,0.06)] ring-1" style={{ background: `linear-gradient(135deg, ${BRAND.blueLight} 0%, ${BRAND.white} 100%)`, borderColor: BRAND.border }}>
            ...
            <div className="mt-4 rounded-[28px] bg-white p-5 ring-1" style={{ borderColor: BRAND.border }}>
              ...
              <p className="mt-1 font-bold" style={{ color: BRAND.slate }}>{scoring.title}</p>
              <ul className="mt-4 space-y-2 text-sm" style={{ color: BRAND.slate }}>
                {scoring.riskSkills.slice(0, 3).map((reason) => <li key={reason.id}>• {reason.skill}</li>)}
              </ul>
            </div>
          </div>
